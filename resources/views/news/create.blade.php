...
@section('contents')
    <div>
        ...
        <form action="{{route('news.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img style="border-width: 1px" class="w-50 h-50 img-thumbnail m-2" id="result"/>

                <p style="height: 0" class='text-danger m-0 p-0 invisible' id="image-error-message">Файл должен быть
                    изображением!</p>
            </div>
            <div class="mb-3">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            const message = $('#image-error-message');
