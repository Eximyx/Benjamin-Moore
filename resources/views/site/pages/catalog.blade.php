    ...
    <div class="catalog-block">
        ...
        <form id="catalog" action="" class="catalog-form" enctype="multipart/form-data">
            ...
            <div class="dropdown_with-chk">
                <button type="button" id="jobs-button"
                        class="dropdown_with-chk__button">@lang('catalog.filter.defaultValue')</button>
                <ul class="dropdown_with-chk__list" id="jobs">
                    <li class="dropdown_with-chk__list-item">
                        <input type="checkbox" name="kind_of_work_id" id="K_1"
                               class="dropdown_with-chk__list-item_label">
                        <label for="K_1"
                               class="dropdown_with-chk__list-item_label">@lang('catalog.filter.internalWork')</label>
                    </li>
                    <li class="dropdown_with-chk__list-item">
                        <input type="checkbox" name="kind_of_work_id" id="K_2"
                               class="dropdown_with-chk__list-item_label">
                        <label for="K_2"
                               class="dropdown_with-chk__list-item_label">@lang('catalog.filter.externalWork')</label>
                    </li>
                </ul>
            </div>
            <label class="form-label" for="series">@lang('catalog.filter.series')</label>
            <div class="dropdown_with-chk">
                <button type="button" id="series-button"
                        class="dropdown_with-chk__button">@lang('catalog.filter.defaultValue')</button>
            ...
            <div class="dropdown_with-chk">
                <button type="button" id="colors-button"
                        class="dropdown_with-chk__button">@lang('catalog.filter.defaultValue')</button>
            ...
            <div class="catalog-form__budget-block" id="budget">
                <input type="text" name="price[from]" class="form-input"
                       placeholder="@lang('catalog.filter.prices.from')">
                <p>-</p>
