...
@section('content')
    ...
    <section class="contact-section">
        <div class=" contacts-block">
            ...
            @if (count($data['data']))
                <div class="contacts-block">
                    ...
                    @foreach($data['data']->resource as $index => $partner)
                        <div class="contacts-inner-block">
                            <img src="{{Vite::asset('resources/icons/point.svg')}}" alt="">
        ...
        {{-- TODO FRONT: add an image placeholder for this {{$data['banner']->image ?? Vite::asset('resources/images/news-mock-image.png')}} --}}
