    ...
    <div
        ...
        <div class=" col-md-4 col-lg-5 col-xl-4 justify-content-between row align-items-center">
            <div class=" col-lg-7 col-xl-6 row" style="font-size:12px">
                ...
                <p class="p-0 text-secondary text-nowrap m-0">
                    <i class="fa fa-clock text-danger"></i>
                    ПН — ПТ, 10:00 — 19:00
                </p>
            </div>
            <a class="nav-link text-black-50 fs-5 col-md-2 col-lg-2 fa fa-shop m-0 p-0" href="{{route('cart')}}">
            ...
            @if (auth()->user() == null )
            <a class="nav-link btn btn-danger text-center text-nowrap text-white fs-6 m-0 py-1" href="{{route('login')}}">
                Войти
            </a>
            @else
            <a class="nav-item dropdown no-arrow fs-6 m-0 py-1">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    ...
                    <img class="img-profile rounded-circle img-fluid" src="{{ url('storage/image/profile.svg') }}" alt="...">
                </a>
