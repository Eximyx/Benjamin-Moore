...
Route::prefix('admin/settings')->group(function () {
    ...
    Route::prefix('/banners')->group(function () {
        Route::controller(BannersController::class)->group(function () {
            Route::post('/delete', 'delete')->name('settings.delete.banner');
            Route::post('/create', 'create')->name('settings.create.banner');
            Route::post('/edit', 'edit')->name('settings.edit.banner');
            Route::post('/update', 'update')->name('settings.update.banner');
            Route::post('/toggle', 'toggle')->name('settings.toggle.banners');
        });
    });
